...
export const DRINKS: Drink[] = [
    {
        ...
        name: 'Sloppy seconds',
        ingredients:[
          {quantity: 2, name: 'Moonshine'},
          {quantity: 2, name: 'Water'},
          {quantity: 1, name: 'Tampon'},
        ],
        author: 'Harvey Dent',
      ...
      },
      {
        ...
        name: 'Mayhem Mohito',
        ingredients:[
          {quantity: 2, name: 'Leaves, any will do.'},
          {quantity: 2, name: 'Water'},
          {quantity: 5, name: 'Light beer'},
        ],
        author: 'Harvey Dent',
        description: 'Perfect for a late night cap',
      ...
      },
      {
        ...
        ingredients:[
          {quantity: 1, name: 'Moonshine'},
          {quantity: 1, name: 'Moonshine'},
          {quantity: 9, name: 'Chloroform'},
        ],
        author: 'Harvey Dent',
        description: 'Perfect for a late night cap',
